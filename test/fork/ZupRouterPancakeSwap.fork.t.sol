...
/// @dev Fork tests targeting PancakeSwap using the ZupRouter
contract ZupRouterPancakeSwapForkTest is BaseForkTest(ForkNetwork.ETHEREUM) {
  using SafeERC20 for IERC20;

  address private pancakeSwapNonFungiblePositionManager;

  function setUp() public override {
    pancakeSwapNonFungiblePositionManager = 0x46A15B0b27311cedF172AB29E4f4766fbE7F4364;
    super.setUp();
  }

  function testFork_depositPancakeSwapV3() public {
    ...
    uint256 tokenId = zupRouter.deposit(
      ...
      pancakeSwapNonFungiblePositionManager,
      depositCalldata
    );

    assertEq(IERC721(pancakeSwapNonFungiblePositionManager).ownerOf(tokenId), address(this));
  }
}
